...
def Rithomgame_run():
    ...
    # 게임 루프
    while running:
        # GPIO.output(11, GPIO.HIGH)  # 녹색
        # GPIO.output(13, GPIO.LOW)   # 노란색
        # GPIO.output(15, GPIO.LOW)   # 빨간색
    ...
    # GPIO.output(11, GPIO.LOW)   # 녹색 off 18
    # GPIO.output(13, GPIO.HIGH)  # 노란색 on 15
    # time.sleep(1)               # 1초 유지
    # GPIO.output(13, GPIO.LOW)   # 노란색 off
    # GPIO.output(15, GPIO.HIGH)  # 빨간색 14
    pygame.quit()
    sys.exit()
if __name__ == "__main__":
     if Rithomgame_run() == "QUIT":
        import main  
